        ...
        <div className="container mx-auto h-auto grid grid-cols-5 gap-8">
          <div className="w-full h-full bg-white px-4 col-span-4">
              ...
              {products.map((item) => (
                ...
                >
                  <div className="w-full flex items-center gap-6">
                    ...
                    <div>
                      <p className="text-lg font-titleFont font-semibold flex justify-end">
            ...
            <div onClick={() => dispatch(resetCart())} className="w-full py-2">
              <button className="px-10 py-2 bg-red-500 hover:bg-red-600 active:bg-red-500 text-white rounded-lg font-titleFont font-semibold text-lg trackin-wide">
                Clear Cart
              </button>
            </div>
          </div>
          <div className="w-full h-52 bg-white col-span-1 flex flex-col items-center justify-center p-4">
            <div>
              <p className="flex gap-2 items-start text-sm">
                ...
                Your order quantities for FREE Shipping Choose this option at
            ...
            <button className="w-full font-titleFont font-medium text-base bg-gradient-to-tr from-yellow-400 to-yellow-200 border hover:from-yellow-300 hover:t0-yellow border-yellow-500 hover:border-yellow-700 active:bg-gradient-to-bl active:from-yellow-400 active:to-yellow-500 duration-200 py-1.5 rounded-md mt-3">
              Proceed to Pay
            </button>
          </div>
        </div>
        ...
        >
          ...
          <div className="w-96 p-4 bg-white flex flex-col items-center rounded-md shadow-lg">
            ...
            <p className="text-sm text-center">
              Your Shopping cart lives to serve. Give iit purpose - fill it with
