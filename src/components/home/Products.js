...
const Products = () => {
  ...
  return (
    <div className="max-w-scren-2xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 xl:gap-10 px-4">
          ...
          <div className="px-4 z-10 bg-white">
            ...
            <div>
              ...
              <button
                ...
                className="w-full font-titleFont font-medium text-base bg-gradient-to-tr from-yellow-500 to-yellow-200 border hover:from-yellow-300 hover:to-yellow border-yellow-500 hover:border-yellow-700 active:bg-gradient-t0-bl active:from-yellow-400 active:to-yellow-500 duration-200 py-1.5 rounded-md mt-3"
              >
                Add to Cart
              </button>
            </div>
